...
1. Differences between using _sessions_ or _JSON Web Tokens_ for authentication.
    ...
    JWT’s use cryptographic signatures and don’t hold state because they are stored client side. Sessions only work with single domains. Sessions are better for small websites.

2. What does `bcrypt` do to help us store passwords in a secure manner.

    it will hash password and can salt both manually & automatically. It also has an algorithm that will hash for as many rounds as specified to make it harder for hackers.

3. How are unit tests different from integration and end-to-end testing.

    Unit tests check specific functions or an application. End to end testing tests the entire application.

4. How _Test Driven Development_ changes the way we write applications and tests.

    TDD makes you write effective/better quality code and reduces the number of bugs. 
